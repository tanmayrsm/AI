...
def main():
    ...
    #font = pygame.font.Font("C:\Users\Tejas\Desktop\Sem 6\tantra\Another Danger Slanted - Demo.otf", 35)
    pygame.display.set_caption('TE CMPN A')
...
def drawPressAnyKeyMsg():
    pressKeyText = font.render('Press Any Key To Play', True, RED)
...
def showStartdisplayScreen():
    title_font = pygame.font.Font('C:\Windows\Fonts\Another Danger Slanted - Demo.otf', 50)
    title_text = title_font.render('Apna Time Ayega', True, BLACK)
    while True:
